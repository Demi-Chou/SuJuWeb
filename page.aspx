<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="page.aspx.cs" Inherits="SuJuWeb1.page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('assets/images/sj2.png'); ">
      <div class="container">
        <div class="row same-height justify-content-center">
          <div class="col-md-6">
            <div class="post-entry text-center">
              <h1 class="mb-4"><asp:Label ID="lblName" runat="server" Text=""></asp:Label></h1>
              <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 me-3 d-inline-block"><img id="imgSinger" runat="server" alt="Image" class="img-fluid" /></figure>
                <span class="d-inline-block mt-1">By <asp:Label ID="lblSinger" runat="server" Text=""></asp:Label></span>
                <span>&nbsp;-&nbsp; <asp:Label ID="lblRelease" runat="server" Text=""></asp:Label></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row blog-entries element-animate">
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="post-content-body">
                <asp:Label ID="lblLyrics" runat="server" Text=""></asp:Label>
