<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SuJuWeb1._Default" %>
			...
			<div class="row">
				...
				<%--<div class="col-lg-4 mb-4">
					<div class="post-entry-alt">
						<a href="page.aspx?song=GrowingPains" class="img-link"><img src="assets/images/img_7_horizontal.jpg" alt="Image" class="img-fluid"></a>
						<div class="excerpt">
							<h2><a href="page.aspx?song=GrowingPains">Growing Pains</a></h2>
							<div class="post-meta align-items-center text-left clearfix">
								<figure class="author-figure mb-0 me-3 float-start"><img src="assets/images/sj1.jpg" alt="Image" class="img-fluid"></figure>
								<span class="d-inline-block mt-1">By <a href="#">Super Junior D&E</a></span>
								<span>&nbsp;-&nbsp; March 23, 2015</span>
							</div>

							<p>그래도 너는 나만큼 더 아프지 않길 매일 바래 수없이도 (oh, oh, oh) 너는 나만큼 기억하지 않길 나보다 괜찮길 바래 Oh 오늘 내일도</p>
							<p><a href="page.aspx?song=GrowingPains" class="read-more">Continue Reading</a></p>
						</div>
					</div>
				</div>--%>
				<%--<div class="col-lg-4 mb-4">
